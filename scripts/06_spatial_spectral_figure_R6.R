...
#
# Generates the spatial/spectral characterization figure for growth
# stage R6 (2024-10-02):
#   (a) segmented canopy objects and subplot layout
#   (b) NDVI
#   (c) MSAVI
#   (d) WDRVI
#
# Spectral display limits use percentiles only for visualization.
# Original raster/index values are not modified.
#
# Inputs:
...
#
# Output:
#   figures/Figure_3_spatial_spectral_R6.png
#
...
out_png <- file.path(
  fig_dir,
  "Figure_3_AB_R6_intermediate.png"
)
...
#
# IMPORTANT:
# The code above constructs panels (a) and (b) and is left unchanged below.
#
# New panels:
#   (c) MSAVI
#   (d) WDRVI
...
#
# This function reproduces the panel-(b) mapping logic.
# It is used for panels (c) and (d), leaving the NDVI panel unchanged.
# ------------------------------------------------------------
...
build_additional_spectral_panel <- function(
  ...
  # ----------------------------------------------------------
  # Main map — same geometry/layout as panel (b)
  # ----------------------------------------------------------
...
# NDVI map with its internal legends
...
out_png_4 <- file.path(
  fig_dir,
  "Figure_3_spatial_spectral_R6.png"
)
